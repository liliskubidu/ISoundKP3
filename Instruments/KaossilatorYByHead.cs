...
{
    class KaossilatorYByHead : Instrument
    {
        public string name;
        ...
        public KaossilatorYByHead(string name) : base(name)
        {
            this.name = name;
        ...
        public override bool CheckAndPlayNote(Body body)
        {
            ...
            var msg5 = new ProgramChangeMessage(StaticMidi.device, Channel.Channel1, (Midi.Instrument)9, 0);// (Midi.Instrument)speed, 0);
            msg5.SendNow();
            Thread.Sleep(2000);
            msg5 = new ProgramChangeMessage(StaticMidi.device, Channel.Channel1, (Midi.Instrument)9, 1);// (Midi.Instrument)speed, 0);
            msg5.SendNow();
            Thread.Sleep(2000);
            msg5 = new ProgramChangeMessage(StaticMidi.device, Channel.Channel1, (Midi.Instrument)9, 2);// (Midi.Instrument)speed, 0);
            msg5.SendNow();
            Thread.Sleep(2000);
            msg5 = new ProgramChangeMessage(StaticMidi.device, Channel.Channel2, (Midi.Instrument)129, 0);// (Midi.Instrument)speed, 0);
            msg5.SendNow();
        ...
        internal void setArpegioSpeed(Body body)
        {
            ...
            {
                var msg4 = new ControlChangeMessage(StaticMidi.device, Channel.Channel1, Midi.Control.KORG_VOLUME, speed, 0);
                msg4.SendNow();
