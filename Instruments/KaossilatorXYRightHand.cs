...
{
    class KaossilatorXYRightHand : Instrument
    {
        public string name;
        ...
        public KaossilatorXYRightHand(string name) : base(name)
        {
            this.name = name;
        ...
        public override bool CheckAndPlayNote(Body body)
        {
            ...
            //********************************************** Y osa = vyska zapesti
                ...
                PlaySound(lWristVelocity, percentageX, percentageY);

            if (MainWindow._arpegiatorSpeed) setArpegioSpeed(body);
